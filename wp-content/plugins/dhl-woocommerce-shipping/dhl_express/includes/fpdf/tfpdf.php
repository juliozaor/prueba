 ...
 *******************************************************************************/
    ...
    function AddPageCustom($orientation = '', $size = '') {
        // Start a new page
        if ($this->state == 0) {
            $this->Open();
        }
        ...
        $start=0;
        $total=10;
        //horizontal lines for second page 
        $this->Line(15, 35, 195, 35);//H
        $this->Line(15, 45, 195, 45);//H
        $this->Line(15, $start + 200 + 00, 195, $start + 200 + 00);//H
        $this->Line(15, $start + 200 + 13, 195, $start + 200 + 13);//H
        $this->Line(15, $start + 200 + 25, 195, $start + 200 + 25);//H
        $this->Line(15, $start + 200 + 31, 195, $start + 200 + 31);//H
        $this->Line(15, $start + 200 + 37, 195, $start + 200 + 37);//H
        $this->Line(15, $start + 200 + 45, 195, $start + 200 + 45);//H


        //vertical line for second page 
        $start=-13;
        $this->Line(27, 48 + $start, 27, 200);//V
        $this->Line(37, 48 + $start, 37, 200);//V
        $this->Line(51, 48 + $start, 51, 200);//V
        $this->Line(62, 48 + $start, 62, 200);//V

        $this->Line(111, 48 + $start, 111, 200);//V
        $this->Line(124, 48 + $start, 124, 200);//V
        $this->Line(145, 48 + $start, 145, 200);//V
        $this->Line(176, 48 + $start, 176, 200);//V
        if(isset($this->settings['include_woocommerce_tax']) && $this->settings['include_woocommerce_tax'] == 'yes'){
            $this->Line(160, 48 + $start, 160, 200);
        }        
        $start=0;

        // footer lines 
        //Line(abscissa ,ending point ,abscissa ,starting point)
        $this->Line(121, $start + 200 + 7, 15, $start + 200+7);//H
        $this->Line(91, $start + 200 + 13, 91, $start + 200);//V
        $this->Line(121, $start + 200 + 13, 121, $start + 200);//V
        $this->Line(150, $start + 200 + 45, 150, $start + 200);//V
        $this->Line(195, $start + 200 + 7, 150, $start + 200+7);//H
        $this->Line(176, $start + 200 + 45, 176, $start + 200);//V
        $this->Line(37, $start + 200 + 13, 37, $start + 200);//V
        $this->Line(62, $start + 200 + 13, 62, $start + 200);//V
        if(isset($this->settings['include_woocommerce_tax']) && $this->settings['include_woocommerce_tax'] == 'yes'){
            $this->Line(150, 219, 195, 219);
        }
    ...
    function Output($name = '', $dest = '') {
        ...
        $plt_return_status = get_option('PLT_return_enabled_express_dhl_elex', false);
        if(!$plt_status && !$plt_return_status){
            ob_clean();
        }

        if($plt_return_status){
            ob_start();
        }
