    ...
    private function wf_get_receiver_details($package){
        ...
        if($packstation_data){
            ...
            if(!empty($address_line2)) {
                $receiver['Address']['streetName'] = $address_line1. ' '. $address_line2;
            }
            else {
                $receiver['Address']['streetName'] = $address_line1;
            }

            $receiver['Address']['streetNumber'] = ' ';// Used invisible character Alt + 255 to provide space, if address line 2 is empty because, normal whitespace is accepted by DHL Paket API
