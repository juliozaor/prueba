                ...
                if(!$domestic){
                    ...
                    foreach($package_details['packed_products'] as $packed_product){
                        ...
                        $customsDetails[$custom_products_count] = array(
                            ...
                            "countryOfOrigin" => get_post_meta($packed_product_id, '_wf_manufacture_country', true),
                            "hsCode" => get_post_meta($packed_product_id, '_wf_hs_code', true),
                            "packagedQuantity" => 1,
...
XML;
    ...
    private function process_result($result = '', $request, $dhl_packages) {
        if(!empty($result)){
            ...
            if(!empty($shipment_ids))
            add_post_meta($this->order_id, 'wf_woo_dhl_ecommerceshipmentId', $shipment_ids, false);
        }
    }
