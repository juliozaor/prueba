...
class UserData implements \ArrayAccess
{
    ...
    public function normalize()
    {
        ...
        $normalized_payload['f5first'] = \PYS_PRO_GLOBAL\FacebookAds\Object\ServerSide\Util::hash(\PYS_PRO_GLOBAL\FacebookAds\Object\ServerSide\Normalizer::normalize('f5first', $this->getF5first()));
        $normalized_payload['f5last'] = \PYS_PRO_GLOBAL\FacebookAds\Object\ServerSide\Util::hash(\PYS_PRO_GLOBAL\FacebookAds\Object\ServerSide\Normalizer::normalize('f5last', $this->getF5last()));
        $normalized_payload['fi'] = \PYS_PRO_GLOBAL\FacebookAds\Object\ServerSide\Util::hash(\PYS_PRO_GLOBAL\FacebookAds\Object\ServerSide\Normalizer::normalize('fi', $this->getFi()));
        $normalized_payload['dobd'] = \PYS_PRO_GLOBAL\FacebookAds\Object\ServerSide\Util::hash(\PYS_PRO_GLOBAL\FacebookAds\Object\ServerSide\Normalizer::normalize('dobd', $this->getDobd()));
        $normalized_payload['dobm'] = \PYS_PRO_GLOBAL\FacebookAds\Object\ServerSide\Util::hash(\PYS_PRO_GLOBAL\FacebookAds\Object\ServerSide\Normalizer::normalize('dobm', $this->getDobm()));
        $normalized_payload['doby'] = \PYS_PRO_GLOBAL\FacebookAds\Object\ServerSide\Util::hash(\PYS_PRO_GLOBAL\FacebookAds\Object\ServerSide\Normalizer::normalize('doby', $this->getDoby()));
